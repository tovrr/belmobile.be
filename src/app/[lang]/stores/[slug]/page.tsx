                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
                                        ...
                                        {shop.googleReviewUrl && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center justify-center gap-2 bg-yellow-400 text-yellow-900 py-4 px-6 rounded-2xl font-bold text-lg hover:bg-yellow-300 transition-all active:scale-95 shadow-lg shadow-yellow-400/20"
                                            >
                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
