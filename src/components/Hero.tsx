                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="text-center lg:text-left z-10">
                        ...
                        >
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-sm font-medium text-slate-500 dark:text-slate-400">500+ Happy Customers</span>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="absolute -right-12 top-20 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl shadow-indigo-500/20 animate-float border border-slate-100 dark:border-slate-700"
                        ...
                        <motion.div
                            ...
                            className="absolute -left-4 bottom-32 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl shadow-indigo-500/20 animate-float border border-slate-100 dark:border-slate-700"
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-slate-900 dark:text-white">{t('< 30 Mins')}</p>
                                </div>
                            </div>
                        </motion.div>
                    </motion.div>
