...
import { BatteryIcon, WifiIcon, FileTextIcon, ShieldCheckIcon, ClockIcon, LeafIcon, CheckCircleIcon, SearchIcon } from '../ui/BrandIcons';
    ...
    return (
        <div className="relative w-full flex items-center justify-center lg:justify-center pt-12 pb-12 lg:py-0">
            ...
            <div className="relative">
                    ...
                    <div className="relative aspect-9/18 bg-slate-900 rounded-[3.5rem] border-8 border-slate-900 shadow-2xl overflow-hidden ring-1 ring-white/10 ring-inset">
                        ...
                        <div className="absolute inset-1 rounded-[3.2rem] bg-black border-2 border-black">
                            ...
                            <div className="absolute inset-0 rounded-[3rem] overflow-hidden bg-slate-950 w-full h-full">
                                ...
                                {/* Status Bar */}
                                <div className="absolute top-4 left-8 z-30 text-[10px] font-bold text-white tracking-widest"><StaticClock /></div>
                                <div className="absolute top-4 right-8 z-30 flex items-center gap-1.5 text-white">
                                    <WifiIcon size={12} strokeWidth={3} />
                                    <BatteryIcon size={12} strokeWidth={3} />
                                </div>
                ...
                <div className="absolute top-[8%] -right-6 md:top-[15%] md:-right-10 z-20 scale-[0.7] sm:scale-75 md:scale-100 origin-bottom-left">
                ...
                <div className="absolute bottom-[18%] -right-6 md:bottom-[26%] md:-right-10 z-20 scale-[0.7] sm:scale-75 md:scale-100 origin-top-left">
                    <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-3 rounded-2xl shadow-xl border border-white/50 dark:border-slate-700 flex items-center gap-3 transform hover:scale-105 transition-transform">
                ...
                {/* Top Left: Warranty */}
                <div className="absolute top-[12%] -left-6 md:top-[25%] md:-left-10 z-20 scale-[0.7] sm:scale-75 md:scale-100 origin-bottom-right">
                    <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-3 rounded-2xl shadow-xl border border-white/50 dark:border-slate-700 flex items-center gap-3 transform hover:scale-105 transition-transform">
                ...
                <div className="absolute bottom-[22%] -left-6 md:bottom-[35%] md:-left-10 z-20 scale-[0.7] sm:scale-75 md:scale-100 origin-top-right">
                    <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-3 rounded-2xl shadow-xl border border-white/50 dark:border-slate-700 flex items-center gap-3 transform hover:scale-105 transition-transform">
